...
seeds = [1012993, 1012997, 1013003, 1013009, 1013029, 1013041, 1013053, 1013063, 1013143, 1013153,
		 1013197, 1013203, 1013227, 1013237,1013239, 1013249,1013263, 1013267,1013279, 1013291,
...
for i in range(20):
	...
	print "+++++++++++++++++++"
	lineaCom = "python main.py " + str(exe) + " " + str(seeds[i]) 
	print lineaCom
